...
def gconnect():
    ...
    try:
        ...
        credentials now we have exchanged authorization code for 
        credentials object'''
...
if __name__ == '__main__':
    ...
    in the browser
    this is helpful during development - but dangerous during deployment
    please turn off, if you deploy'''
